...
def process_args(ports, args, settings, shared):
  if settings.USE_FFMPEG == 1:
    ...
    args += ['-I' + os.path.join(ports.get_build_dir(), 'ffmpeg', 'include', 'ffmpeg')]
  return args
...
# FFMPEG header - it does not export anything
ffmpeg_h = '''/* ffmpeg export file */
/* Manually created by Samsung */
